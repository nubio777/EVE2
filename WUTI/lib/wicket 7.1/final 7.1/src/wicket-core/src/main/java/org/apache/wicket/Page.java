...
public abstract class Page extends MarkupContainer implements IRequestablePage, IQueueRegion {
     ...
     *
     * @param parameters externally passed parameters
     * @see PageParameters
     */
     ...
     *
     * @param component The component that was rendered
     */
     ...
     *
     * @param isInitialization a flag whether this is a page instantiation
     */
     ...
     * bookmarkable.
     *
     * @param value whether the page should try to be stateless
     */
     ...
     *
     * @param renderedContainer The page itself if it was a full page render or the container that was rendered
     *                          standalone
     */
     ...
     *
     * @param component The component whose model is about to change
     */
